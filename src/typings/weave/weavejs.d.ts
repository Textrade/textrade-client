...
declare namespace weavejs.data.source {
    ...
    class GroupedDataTransform extends AbstractDataSource implements ISelectableAttributes {
        ...
        protected generateHierarchyNode(metadata: {
            [key: string]: string;
        }): IWeaveTreeNode;
...
declare class AggregateColumn extends AbstractAttributeColumn implements IPrimitiveColumn {
    constructor(source: GroupedDataTransform);
    private _groupByColumn;
    private _dataColumn;
    private _keys;
    private _cacheTriggerCounter;
    setup(metadata: {
        [key: string]: string;
    }, dataColumn: IAttributeColumn, keys: IQualifiedKey[]): void;
     ...
     * @inheritDoc
     */
    getValueFromKey(groupKey: IQualifiedKey, dataType?: Class): any;
     ...
     */
    getAggregateValue(groupKey: IQualifiedKey, dataType: Class): any;
    /**
     * Gets an Array of values from a column, excluding missing data.
     * Flattens Arrays.
     */
    private static getValues(column, keys, dataType);
}
...
declare namespace weavejs.data {
    ...
    class AttributeColumnCache implements IAttributeColumnCache {
         ...
         */
        convertToCachedDataSources(root: ILinkableHashMap): WeavePromise<CachedColumnData>;
         ...
         */
        restoreCache(root: ILinkableHashMap, cacheData: CachedColumnData): void;
